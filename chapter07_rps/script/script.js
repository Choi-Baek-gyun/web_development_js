...
//       // 사용자가 비긴 경우
//       alert(`유저: ${userInput} - 컴퓨터 : ${comInput} | 컴퓨터와 비겼습니다.`);
//     } else if (comInput === ROCK) {
//       // 사용자가 진 경우
//       alert(`유저: ${userInput} - 컴퓨터 : ${comInput} | 컴퓨터가 이겼습니다.`);
//     } else {
//       // 사용자가 이긴 경우
//       alert(`유저: ${userInput} - 컴퓨터 : ${comInput} | 컴퓨터를 이겼습니다.`);
//     }
...
switch (userInput) {
  case SCISSORS:
    switch (comInput) {
      case SCISSORS:
        alert(
          `유저: ${userInput} - 컴퓨터 : ${comInput} | 컴퓨터와 비겼습니다.`
        );
      case ROCK:
        alert(
          `유저: ${userInput} - 컴퓨터 : ${comInput} | 컴퓨터가 이겼습니다.`
        );
      case PAPER:
        alert(
          `유저: ${userInput} - 컴퓨터 : ${comInput} | 컴퓨터를 이겼습니다.`
        );
        break;
    }
    break;
